...
public class OptimovePreferenceCenter {
    ...
    fileprivate static var instance: OptimovePreferenceCenter?
    ...
    public static func getPreferences() async throws -> Preferences {
        guard let instance = OptimovePreferenceCenter.instance,
              let config = instance.config,
              let storage = instance.storage,
              let networkClient = instance.networkClient
        else {
            throw OptimovePreferenceCenter.Error.configurationIsMissing
        }
    ...
    public static func setPreferences(updates preferenceUpdates: [PreferenceUpdateRequest]) async throws -> Preferences {
        do {
            guard
                let instance = OptimovePreferenceCenter.instance,
                let config = instance.config,
                let storage = instance.storage,
                let networkClient = instance.networkClient
            else {
