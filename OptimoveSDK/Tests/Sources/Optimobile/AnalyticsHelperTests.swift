...
class MockKSHttpClient: KSHttpClient {
    ...
    // All events accumulated across all requests (tests inspect this as the captured payload)
    ...
    // Auth tracking: last authUserId and the full history across requests
