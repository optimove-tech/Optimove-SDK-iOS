...
class Optimobile {
    ...
    public enum Abilities {
        case deppLinking(responder: deepLinkComplition?), inApp(responder: inAppComplition?, inAppConsentStrategy: InAppConsentStrategy), pushOpened(responder: pushOpenedComplition?)
    }
    ...
    public static func configure(for tenantInfo: OptimoveTenantInfo, apiKey: String, secretKey: String, abilities: [Abilities]? = nil) {
        ...
        builder = KSConfigBuilder(apiKey: apiKey, secretKey: secretKey).enableCrash()
    ...
    public static func disablePushCampaigns() {
        //        Optimove.shared.disablePushCampaigns()
    ...
    //    public static func unregisterDeepLink(deepLinkResponder responder: OptimoveDeepLinkResponder) {
    //
    //    }
    ...
    //    public static func unregisterInApp(deepLinkResponder responder: OptimoveDeepLinkResponder) {
    //
    //    }
